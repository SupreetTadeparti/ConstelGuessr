...
def load_augmented_data(data_folder="augmented_data_final2"):
    """
    Loads and preprocesses augmented constellation data from JSON files.
...
def train_constellation_model(
    features,
    labels,
    model_save_path="constellation_model_last.pkl",
    encoder_save_path="label_encoder_last.pkl",
):
    """
...
if __name__ == "__main__":
    ...
    data_folder = "augmented_data_final2"  # Folder containing JSON data files
